...
void extractInfo( char *input, char *output, char DELIMITER )
{
  ...
  while( input[ increment ] != DELIMITER )
  {
    increment++;
  }
...
int checkMalformedConfig( FILE* config, char DELIMITER )
{
  ...
  if( strCompareToDelim( inputBuffer, "Version/Phase:", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  ...
  if( strCompareToDelim( inputBuffer, "CPU Scheduling Code:", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  ...
  if( strCompareToDelim( inputBuffer, "Quantum Time (cycles):", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  ...
  if( strCompareToDelim( inputBuffer, "Memory Available (KB):", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  ...
  if( strCompareToDelim( inputBuffer, "Processor Cycle Time (msec):", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  ...
  if( strCompareToDelim( inputBuffer, "I/O Cycle Time (msec):", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  //log to check
  ...
  if( strCompareToDelim( inputBuffer, "Log To:", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
  //Log File Path check
  ...
  if( strCompareToDelim( inputBuffer, "Log File Path:", DELIMITER ) != 0 )
  {
    return MALFORMED;
  }
